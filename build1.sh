...
prepare_xz() {
  ...
  CFLAGS="-mtune=generic -O3 -g0 -flto" CXXFLAGS="-mtune=generic -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-silent-rules --enable-static --disable-shared --disable-doc --enable-debug=no --disable-nls
  make -j$(nproc)
  make install
...
prepare_libxml2() {
  ...
  CFLAGS="-mtune=generic -O3 -g0 -flto" CXXFLAGS="-mtune=generic -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-silent-rules --without-python --without-icu --enable-static --disable-shared
  make -j$(nproc)
  make install
...
prepare_sqlite() {
  ...
  CFLAGS="-mtune=generic -O3 -g0 -flto" CXXFLAGS="-mtune=generic -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --build="${BUILD_ARCH}" --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-static --disable-shared  ${SQLITE_EXT_CONF} \
    --disable-debug \
    --enable-editline=no \
...
prepare_c_ares() {
  ...
  CFLAGS="-mtune=generic -O3 -g0 -flto" CXXFLAGS="-mtune=generic -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-static --disable-shared --enable-silent-rules --disable-tests --without-random
  make -j$(nproc)
  make install
...
prepare_libssh2() {
  ...
  CFLAGS="-mtune=generic -O3 -g0 -flto" CXXFLAGS="-mtune=generic -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-static --disable-shared --enable-silent-rules \
...
build_aria2() {
  ...
  CFLAGS="-march=tigerlake -O3 -g0 -flto" CXXFLAGS="-march=tigerlake -O3 -g0 -flto" LDFLAGS="-flto -s" ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-static --disable-shared --enable-silent-rules ARIA2_STATIC=yes ${ARIA2_EXT_CONF}
  make -j$(nproc)
  make install
