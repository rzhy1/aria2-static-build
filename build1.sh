...
echo "⭐⭐⭐⭐⭐⭐$(date '+%Y/%m/%d %a %H:%M:%S.%N') - x86_64-w64-mingw32-gcc --version⭐⭐⭐⭐⭐⭐"
x86_64-w64-mingw32-gcc --version
echo "⭐⭐⭐⭐⭐⭐$(date '+%Y/%m/%d %a %H:%M:%S.%N') - x86_64-w64-mingw32-gcc --version⭐⭐⭐⭐⭐⭐"
${CROSS_ROOT}/bin/x86_64-w64-mingw32-gcc --version
echo "⭐⭐⭐⭐⭐⭐$(date '+%Y/%m/%d %a %H:%M:%S.%N') - gcc-14.2.1 --version⭐⭐⭐⭐⭐⭐"
${CROSS_ROOT}/bin/x86_64-w64-mingw32-gcc-14.2.1 --version
...
build_aria2() {
  ...
  CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ ./configure --host="${CROSS_HOST}" --prefix="${CROSS_PREFIX}" --enable-static --disable-shared --enable-silent-rules ARIA2_STATIC=yes ${ARIA2_EXT_CONF}
  make -j$(nproc)
  make install
